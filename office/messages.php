        ...
        <center><h4 class="text-center text-info"><span class="fa fa-inbox"></span> Inbox</h4></center>
            ...
            <ul>
                    ...
                    while($row = mysqli_fetch_assoc($q)){
                        echo "<a href='?office={$row['userid']}' class='list-group-item'> {$row['name']} <span class='badge'>{$row['office_name']}</span></a>";
                    }
                ?>
            </ul>
        </div>
                ...
                if(isset($_GET['office'])){
                    ...
                    if(mysqli_num_rows($q) == 1){
                        ...
                        if(mysqli_num_rows($conver) == 1){
                            ...
                            $q = mysqli_query($conn, "INSERT INTO `conversation` (`user_one`, `user_two`) VALUES ('{$user_one}', '{$user_two}');");
