            	...
            	<div class="row">
		                	...
		                	<ul class="nav nav-pills nav-stacked">
		                		<li class="nav-item text-nowrap">
		                    		<a class="nav-link" href="archives.php">
		                      		...
		                      		Document Archives<span class="sr-only">(current)</span>
		                    		</a>
		                  		</li>

                         <li class="nav-item text-nowrap">
                              <a class="nav-link active" href="archive_borrowing.php">
                                <span class="fa fa-list-ul"></span>
                  ...
                  <div class="card">
                    <div class="card-header bg-success text-light">
                      <center><h5><strong>Document Borrowing Record</strong></h5></center>
                    </div>
                ...
                <div class="pull-left">
                  <button class="btn btn-sm btn-outline-secondary dropdown-toggle" data-toggle="dropdown" title="Print Document"><span class="fa fa-print"></span> Print Record<span class="caret"></span></button>
                        <ul class="dropdown-menu dropdown-menu-right">
                          <li class="dropdown-item"><a tabindex="-1" onclick="window.open('print/print_borrowing_annual_archive.php?office=<?php echo $offices ?>', '_blank', 'location=yes, height=470, width=740, scrollbars=yes, status=yes');">Annual Report</a></li>
                          <li class="dropdown-divider"></li>
                          <li class="dropdown-item dropdown-submenu">
                            <a class="test" tabindex="-1" href="#">Quarterly Report <span class="fa fa-toggle-right"></span></a>
                            <ul class="dropdown-menu">
                              <li class="dropdown-item ><a tabindex="-1" onclick="window.open('print/print_borrowing_quarter1_archive.php?office=<?php echo $offices ?>', '_blank', 'location=yes, height=470, width=740, scrollbars=yes, status=yes');">1st Quarter</a></li>
                              <li class="dropdown-item ><a tabindex="-1" onclick="window.open('print/print_borrowing_quarter2_archive.php?office=<?php echo $offices ?>', '_blank', 'location=yes, height=470, width=740, scrollbars=yes, status=yes');">2nd Quarter</a></li>
                              <li class="dropdown-item ><a tabindex="-1" onclick="window.open('print/print_borrowing_quarter3_archive.php?office=<?php echo $offices ?>', '_blank', 'location=yes, height=470, width=740, scrollbars=yes, status=yes');">3rd Quarter</a></li>
                              <li class="dropdown-item ><a tabindex="-1" onclick="window.open('print/print_borrowing_quarter4_archive.php?office=<?php echo $offices ?>', '_blank', 'location=yes, height=470, width=740, scrollbars=yes, status=yes');">4th Quarter</a></li>
                            </ul>
                          </li>  
                        </ul>                  
                </div>
                      ...
                      WHERE borrowing.active = 0 AND borrowing.office_id =  {$_SESSION['office_id']}
                          ");
                          ...
                          while ($rows = mysqli_fetch_array($result)) { ?>
                            ...
                            <tr>
                               ...
                               <td class="text-center">
                                        ...
                                        <a href="#restoreborowing<?php echo $rows['borrowing_id']; ?>" data-toggle="modal" data-tooltip="tooltip" title="Restore this record?" class="btn btn-sm btn-outline-primary"><span class="fa fa-recycle "></span></a>
                                       </td>
                                  <?php  
