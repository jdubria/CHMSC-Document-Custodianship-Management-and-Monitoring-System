...
<body onload="window.print();">
    ...
    <h3 class="text-center">All Active Borrowing Records 4th Quarter</h3>
...
WHERE borrowing.active = 1 AND borrowing.remarks = 'returned' AND YEAR(borrowing.date) = YEAR(NOW()) AND office.office_id = $office
AND MONTH(borrowing.date) BETWEEN 10 AND 12
