...
<html>
<head>
	<title>CHMSC-Binalbagan DCMMS Fourth Quarter Print</title>
...
WHERE document.active = 1 AND month(document.`date-uploaded`) BETWEEN 10 AND 12
AND year(document.`date-uploaded`) = year(now()) AND document_classification.dc_id = 1 AND office.office_id = $office;
                ");
