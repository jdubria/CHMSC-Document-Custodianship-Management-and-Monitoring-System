      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
          <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group mr-2">
                        <a href="#addnew" data-toggle="modal" data-tooltip="tooltip" title="Upload New Document to Send" class="btn btn-sm btn-outline-primary"><span class="fa fa-plus"></span> Document to Send</a>
                    </div>    	
                </div>
      </div>
                		...
                		<li class="nav-item text-nowrap">
                  		...
                  		<li class="nav-item text-nowrap">
                      		<a class="nav-link active" href="#">
                      			...
                      			<strong>Send Document<span class="sr-only">(current)</span></strong>
                    		</a>
                  		</li>
                	</ul>
                	</div>
            ...
            <thead>
             <tr>
               <th class="text-center"></th>
                     ...
                     <th class="text-center">Send Document</th>
...
WHERE document.dc_id = 1 AND document.active = 1 AND send_doc = 1;           
           "); 
            ?>
            ...
            <tr>
              ...
              <td class="text-center"><a href="#senddocument<?php echo $rows['id']; ?>" data-toggle="modal" data-tooltip="tooltip" title="Send document: <?php echo $rows['name']; ?>" class="btn btn-success rounded-circle btn-sm"><span class="fa fa-send"></span></a></td>
            ...
            <?php include 'modals/send_modal.php' ?>
            <?php } ?>
          </tbody>
        </table>
      </div>			
...
<?php 
include('modals/add_modal_send.php');
