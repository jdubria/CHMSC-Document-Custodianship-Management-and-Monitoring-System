            ...
            <div class="container-fluid">
            	<div class="row">
                          ...
                          <li class="nav-item text-nowrap">
                              <a class="nav-link" href="archive_borrowing.php">
                                ...
                                Borrowing Record Archives
		                  		...
		                  		<li class="nav-item text-nowrap">
		                      		<a class="nav-link active" href="archive_documenttype.php">
		                      			<span class="fa fa-list-ul"></span>
                  ...
                  <div class="card">
                    ...
                    <center><h5><strong>Document Type</strong></h5></center>
                    </div>
                    <div class="card-body">
                    ...
                    <thead class="thead-inverse">
                        <th class="text-center">Name Type</th>
                         <th class="text-center">Restore</th>
                          ...
                          <tbody>
                        <?php 
                        $result = mysqli_query($conn, "SELECT * FROM document_type WHERE active = 0;"); 
                        ...
                        <tr>
                           ...
                           <td class="text-center">
                                    ...
                                    <a href="#restore_type<?php echo $rows['dt_id'] ?>" data-toggle="modal" data-tooltip="tooltip" title="Restore document: " class="btn btn-sm btn-outline-primary"><span class="fa fa-recycle "></span></a>
                                   </td>
