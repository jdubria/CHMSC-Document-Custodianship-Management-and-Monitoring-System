            	...
            	<div class="row">
                          ...
                          <li class="nav-item text-nowrap">
                              <a class="nav-link" href="archive_borrowing.php">
                                ...
                                Borrowing Record Archives
		                  		...
		                  		<li class="nav-item text-nowrap">
		                      		<a class="nav-link active" href="archive_office.php">
		                      			<span class="fa fa-home"></span>
		                      			Office Archives
		                    		</a>
		                  		</li>
                  ...
                  <div class="card">
                    <div class="card-header bg-success text-light">
                       <center><h5><strong>Offices and Document Default</strong></h5></center>
                    </div>
                      ...
                      <div class="table-responsive">
                        ...
                        <thead class="thead-inverse">
                            <th class="text-center">Office Name</th>
                             <th class="text-center">Office Document Code Value</th>
                             <th class="text-center">Restore</th>
                              </thead>
                              <tbody>
                         <?php 
                         $result = mysqli_query($conn, "SELECT * FROM office WHERE active = 0;");
                         while ($rows = mysqli_fetch_array($result)) { ?>     
                            <tr>
                               ...
                               <td class="text-center">
                                        ...
                                        <a href="#restoreoffice<?php echo $rows['office_id']; ?>" data-toggle="modal" data-tooltip="tooltip" title="Restore office: <?php echo $rows['office_name']; ?>" class="btn btn-sm btn-outline-primary"><span class="fa fa-recycle "></span></a>
                                       </td>
