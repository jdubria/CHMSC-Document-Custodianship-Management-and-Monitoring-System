            	...
            	<div class="row">
                          ...
                          <li class="nav-item text-nowrap">
                              <a class="nav-link" href="archive_borrowing.php">
                                ...
                                Borrowing Record Archives
		                  		...
		                  		<li class="nav-item text-nowrap">
		                      		<a class="nav-link active" href="archive_user.php">
		                      			<span class="fa fa-users"></span>
		                      			User Archives
		                    		</a>
		                  		</li>
                  ...
                  <div class="card">
                    <div class="card-header bg-success text-light">
                        <center><h5><strong>User's Profile</strong></h5></center>                      
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        ...
                        <thead class="thead-inverse">
                             ...
                             <th class="text-center">Registered Since</th>
                          ...
                          if ($rows['user_level'] == 1) {
                           $userlvl = "Administrator";
                            ...
                            <tr>
                                ...
                                <td><?php echo $rows['name'] ?></td></td>
                                <td><?php echo $rows['address'] ?></td></td>
                                <td><?php echo $rows['contact'] ?></td></td>
                                      
                               <td class="text-center">
                                      
                                        <a href="#restore_user<?php echo $rows['userid'] ?>" data-toggle="modal" data-tooltip="tooltip" title="Restore document: " class="btn btn-sm btn-outline-primary"><span class="fa fa-recycle "></span></a>
                                       </td>
